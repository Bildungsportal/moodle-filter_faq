...
$string['cachedef_pages'] = 'Cache for paths and ids of pages';
$string['cachedef_string'] = 'Cache for stringlib';
$string['callable:class_missing'] = 'Class {$a->class} does not exist or is no compatible filter_faq callable';
...
$string['exception:file_path_invalid'] = 'The requested file path is invalid!';
...
$string['permalink:copied_to_clipboard'] = 'Permalink was copied to the clipboard';
...
$string['search:languages'] = 'Search API languages';
$string['search:languages_help'] = 'Please specify all languages that shall be indexed by the Search API. List them line by line. Lines starting with a hash-tag are ignored. The default language will always be added automatically.';
$string['search:pages'] = 'Search FAQ pages';
$string['task:scanpages'] = 'Scan pages';
...
$string['support_form'] = 'Contact Support';
